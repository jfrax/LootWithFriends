...
namespace LootWithFriends
{
    public static class UserPreferences
    {
        ...
        // Defaults
        private static bool _createWaypointsForBagsIDrop = false;
        ...
        private static void LoadOrCreate()
        {
            ...
            try
            {
                ...
                if (data == null)
                    throw new Exception("Deserialized PreferencesDto was null.");
        ...
        {
            public bool CreateWaypointsForBagsIDrop { get; set; } = false;
